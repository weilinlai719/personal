...
import { C as unescapeHTML, f as renderTemplate, h as generateCspDigest, n as renderScriptElement, o as renderComponent, r as renderUniqueStylesheet, t as spreadAttributes, x as createHeadAndContent } from "./server_4y7-RSFg.mjs";
...
var ImmutableDataStore = class ImmutableDataStore {
	...
	*/
	static async fromModule() {
		try {
			const data = await import("./_astro_data-layer-content_NK9zHR5_.mjs");
...
async function updateImageReferencesInBody(html, fileName) {
	...
	const { getImage } = await import("./_virtual_astro_get-image_BUzp-DQ4.mjs");
