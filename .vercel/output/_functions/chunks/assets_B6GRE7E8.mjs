import { C as InvalidImageService, H as RemoteImageNotAllowed, c as ExpectedImageOptions, l as ExpectedNotESMImage, nt as AstroError, s as ExpectedImage } from "./errors-data_D7NJRD9d.mjs";
import { i as isRemoteAllowed, t as inferRemoteSize } from "./remoteProbe_C-T9yJHH.mjs";
import { a as isESMImportedImage, i as resolveDefaultOutputFormat, n as isLocalService, o as isRemoteImage, s as resolveSrc } from "./service_CFF1mjh3.mjs";
...
async function getConfiguredImageService() {
	if (!globalThis?.astroAsset?.imageService) {
		const { default: service } = await import("./sharp_CZqggvL8.mjs").catch((e) => {
